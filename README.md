...
For example, if you have generated test case for the `commons-dbcp_6ce68bf` project, you can see
```console
root:~/unitcon/unitcon# cat ../results/commons-dbcp_6ce68bf/commons-dbcp_6ce68bf/UnitconTest1.java
